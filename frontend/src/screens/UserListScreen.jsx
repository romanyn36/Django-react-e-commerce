        ...
        <div>
            ...
            <Card className="mb-4 shadow-sm">
                <Card.Header className="bg-primary text-white">
                    <Row>
                        <Col><h3><i className="fas fa-users me-2"></i> User Management</h3></Col>
                    </Row>
                </Card.Header>
                <Card.Body>
                    <Row className="mb-3 align-items-center">
                        <Col md={6}>
                            <h5>Total Users: <Badge bg="secondary">{filteredUsers.length}</Badge></h5>
                        </Col>
                        <Col md={6}>
                            <InputGroup>
                                        ...
                                        {currentUsers.map(user => (
                                            <tr key={user.id}>
                                                ...
                                                <td className="text-center">
                                                    {user.isAdmin ? (
                                                        <Badge bg="success">Admin <i className='fas fa-check ms-1'></i></Badge>
                                                    ) : (
